...
\def\comment#1{\hfill{\color{light-gray}{$\left\{\textrm{{\em{#1}}}\right\}$}}}
\def\lcomment#1{\hfill{\color{light-gray}{$\left\{\textrm{{\em{#1}}}\right.$}}}
\def\rcomment#1{\hfill{\color{light-gray}{$\left.\textrm{{\em{#1}}}\right\}$}}}
\def\fcomment#1{\hfill{\color{light-gray}{$\textrm{{\em{#1}}}$}}}
...
%TODO: add red right justified comments about what to parallelize
...
\disableframe{\frametitle{Terminology}
    \begin{itemize}
...
%TODO: move/replace/delete this slide EDIT?
\disableframe{\frametitle{Motivation for (P)BFS}
    ...
    \begin{itemize}
        ...
        \item Hot topic recently
    \end{itemize}
}

\disableframe{\frametitle{Existing Algorithms}
    \begin{itemize}
...
\disableframe{\frametitle{General Approaches}
    \begin{itemize}
...
%TODO: Summarize results before description AND in conclusion Rewrite not using n,m
\section{TBN-BFS}
    ...
    \begin{enumerate}
        \item One input queue $Q_{in}\subseteq \V$
            \begin{enumerate}
                ...
                \item $\forall u \in Q_{in} : \size{\Gamma_u} > 0$
            \end{enumerate}
...
\frame{\frametitle{TBN-BFS - Dedup Vertexes and Combine Queues}
    \begin{enumerate}
        \item $Size_{-1} = 0$
...
\frame{\frametitle{Conclusions}
    \begin{itemize}
        \item TBN-BFS has optimal $T_1, T_P, W_P$ in our computation model
        \item TODO MORE?
    \end{itemize}
}
...
\frame{\frametitle{Future Work}
    \begin{itemize}
        ...
        \item Implement, optimize, and compare to existing algorithms
    \end{itemize}
}
